...
> 🤖 本项目由 [Trae](https://www.trae.ai/) + AI 全程自动化编写，从架构设计、代码实现到测试验证均由 AI 驱动完成。现已迁移至 **Trae CN** 持续迭代。
...
### 在途优化（短期）
- [x] Dashboard 任务卡片支持导航至任务详情页（`/tasks/:id`）+ 新建扫描快捷入口
- [x] 统一 NB_EVENT v1 事件 schema（core/cli/web/recon 完整闭环）
