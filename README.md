...
- **多模型 Provider** — Ollama / OpenAI-compatible / Anthropic (Claude) / DeepSeek / Gemini / Azure OpenAI / 硅基流动 等开箱即用
...
- **Providers**：支持 Ollama、OpenAI-compatible、Anthropic (Claude)、DeepSeek、Gemini、Azure OpenAI 端点
